  ...
  <v-container fluid>
    <v-layout wrap>
      ...
      <v-flex xs8>
        ...
        Please select the shipping address.<a href="#">Type Address</a>
        </v-alert>
    ...
    <v-divider class="mt-10 mb-10"></v-divider>
      ...
      <v-flex xs4 class="mt-15">
        <p class="mb-0">5 <v-icon left color="yellow">mdi-star</v-icon> <vm-progress :percentage="0">0%</vm-progress></p>
        <p class="mb-0">4 <v-icon left color="yellow">mdi-star</v-icon> <vm-progress :percentage="70">70%</vm-progress></p>
        <p class="mb-0">3 <v-icon left color="yellow">mdi-star</v-icon> <vm-progress :percentage="30">30%</vm-progress></p>
        <p class="mb-0">2 <v-icon left color="yellow">mdi-star</v-icon> <vm-progress :percentage="30">30%</vm-progress></p>
        <p class="mb-0">1 <v-icon left color="yellow">mdi-star</v-icon> <vm-progress :percentage="20">20%</vm-progress></p>
