<template>
  <div>
    ...
    <v-card-title class="text-center justify-center py-6">
      <h3 class="font-weight-bold display-3 basil--text">Checkout Page</h3>
    </v-card-title>
              ...
              <v-flex
                ...
                >
                 <v-simple-table class="pb-10">
                  <tr width="500" >
                    <v-radio label="Credit Cart" value="credit-cart" class="mr-3 mt-5 ml-3"></v-radio>
                ...
                >
                 <v-simple-table>
                  <tr>
                    <td width="600">
                      <v-radio label="Payal" value="payment" class="mr-3 mt-5 ml-3"></v-radio>
